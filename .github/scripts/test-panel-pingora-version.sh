...
create_fixture() {
  local root="$1"
  local mode="$2"
  local http_version="0.9.0"
  local http_requirement='=0.9.0'
  local reported_version="0.9.0"
  ...
  create_package "$root/dependencies" pingora 0.9.0
  create_package "$root/dependencies" pingora-core 0.9.0
  create_package "$root/dependencies" pingora-http "$http_version"
  create_package "$root/dependencies" pingora-load-balancing 0.9.0
  if [[ "$mode" == redirected ]]; then
    create_package "$root/redirected" pingora-core 0.9.0
  fi

  {
    printf '[package]\nname = "gateway-pingora"\nversion = "0.1.0"\nedition = "2021"\n'
    printf '\n[dependencies]\n'
    printf 'pingora = { version = "=0.9.0", path = "../../dependencies/pingora" }\n'
    printf 'pingora-core = { version = "=0.9.0", path = "%s" }\n' "$core_path"
    printf 'pingora-http = { version = "%s", path = "../../dependencies/pingora-http" }\n' \
      "$http_requirement"
    printf 'pingora-load-balancing = { version = "=0.9.0", path = "../../dependencies/pingora-load-balancing" }\n'
